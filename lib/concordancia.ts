...
const NAC_ES: Record<string, string> = {
...
function nacES(nac: string): string {
  return NAC_ES[nac.toLowerCase()] || nac;
}
...
export function buildCertificacionTextos(data: PoderData, c: Concordancia) {
  ...
  return {
    ...
    leido_EN: `This instrument read by me, the Notary, to the grantor and previous explanation and warnings I made about its validity, scope and legal consequences, ${c.elLaEN} stated ${c.HisHer} agreement to its contents, ratified, and signed it before me.`,
